...
const SERVICE_TYPES = ["城市漫游", "旅游打卡", "美食探店", "摄影跟拍", "户外轻运动", "桌游同行", "商务接待", "展会协助", "交通接站", "办事陪同"];
...
const schemas = [
  {
    ...
    fields: [
      ...
      phone("手机号"),
      text("微信号"),
      single("所在城市", ["北京", "上海", "广州", "深圳", "成都", "杭州", "西安", "重庆", "武汉", "苏州", "南京", "长沙"]),
      text("服务区域"),
      single("服务类型", SERVICE_TYPES),
      date("预约日期"),
  ...
  },
  {
    ...
    fields: [
      ...
      phone("手机号"),
      text("微信号"),
      single("服务城市", ["北京", "上海", "广州", "深圳", "成都", "杭州", "西安", "重庆", "武汉", "苏州", "南京", "长沙"]),
  ...
  },
  {
    ...
    fields: [
      ...
      text("客户称呼"),
      text("联系方式"),
      single("咨询城市", ["北京", "上海", "广州", "深圳", "成都", "杭州", "西安", "重庆", "武汉", "苏州", "南京", "长沙"]),
      single("咨询类型", ["预约咨询", "入驻合作", "订单进度", "服务者资料补充", "服务反馈", "用户注册", "登录帮助", "费用说明", "隐私与协议", "其他"]),
      text("咨询内容"),
      text("来源页面"),
...
const seedRecords = {
  ...
  服务者入驻申请表: {
    ...
    起步价格: 420,
    计费方式: "半天",
    个人介绍: "熟悉杭州核心商圈、公开景区和高铁站路线，可提供城市漫游、商务接待和基础路线规划服务，沟通稳定，时间安排灵活。",
    擅长内容: ["美食", "路线规划", "商务接待"],
    语言能力: ["普通话", "英语"],
    身份认证状态: "未认证",
    审核状态: "待审核",
  ...
  服务者资料库: {
    ...
    服务状态: "可接单",
    风险等级: "正常",
    对外展示文案: "熟悉杭州核心商圈、公开景区和高铁站路线，可提供城市漫游、商务接待和基础路线规划。",
    内部备注: "自动化测试服务者资料",
